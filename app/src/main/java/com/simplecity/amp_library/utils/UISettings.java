...
public class UISettings extends SettingsManager {
    ...
    private static final String KEY_RECENT_NUM_WEEKS = "pref_num_weeks";

    public int getRecentNumWeeks() {
        return getInt(KEY_RECENT_NUM_WEEKS, 2) * 24 * 7 * 3600;
    }

    public void setRecentNumWeeks(int numWeeks) {
        setInt(KEY_RECENT_NUM_WEEKS, numWeeks);
    }
