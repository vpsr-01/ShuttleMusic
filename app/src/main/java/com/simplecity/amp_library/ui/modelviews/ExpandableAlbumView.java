...
public class ExpandableAlbumView extends MultiItemView<Album> implements ContentsComparator {
    ...
    public ExpandableAlbumView(Album album, @ViewType int viewType, RequestManager requestManager) {
        this.album = album;
        this.viewType = viewType;
        this.requestManager = requestManager;
    }

    public ExpandableAlbumView(Album album, @ViewType int viewType, RequestManager requestManager, MultiSelector multiSelector) {
        this.album = album;
        this.viewType = viewType;
        this.requestManager = requestManager;
    ...
    public void bindView(final ViewHolder holder) {
        ...
        holder.lineTwo.setText(StringUtils.makeAlbumAndSongsLabel(holder.itemView.getContext(), -1, album.numSongs));
        holder.lineThree.setText(String.valueOf(album.year));
    ...
    public boolean equals(Object o) {
        ...
        ExpandableAlbumView albumView = (ExpandableAlbumView) o;
    ...
    public boolean areContentsEqual(Object other) {
        return this.equals(other) && Arrays.equals(prefix, ((ExpandableAlbumView) other).prefix);
