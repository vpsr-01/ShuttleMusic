...
//                startService(context, Constants.MediaButtonCommand.PAUSE);
//
...
//                        command = Constants.MediaButtonCommand.STOP;
//                        break;
//                    case KeyEvent.KEYCODE_HEADSETHOOK:
//                    case KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE:
//                        command = Constants.MediaButtonCommand.TOGGLE_PAUSE;
//                        break;
//                    case KeyEvent.KEYCODE_MEDIA_NEXT:
//                        command = Constants.MediaButtonCommand.NEXT;
//                        break;
//                    case KeyEvent.KEYCODE_MEDIA_PREVIOUS:
//                        command = Constants.MediaButtonCommand.PREVIOUS;
//                        break;
//                    case KeyEvent.KEYCODE_MEDIA_PAUSE:
//                        command = Constants.MediaButtonCommand.PAUSE;
//                        break;
//                    case KeyEvent.KEYCODE_MEDIA_PLAY:
//                        command = Constants.MediaButtonCommand.PLAY;
//                        break;
//                }
//
//                if (command != null) {
...
//                        if (down) {
//                            if ((Constants.MediaButtonCommand.TOGGLE_PAUSE.equals(command) ||
//                                    Constants.MediaButtonCommand.PLAY.equals(command))) {
...
//                    if (command != null) {
//                        final Context context = (Context) msg.obj;
//                        if (Constants.MediaButtonCommand.NEXT.equals((command))) {
//                            beep(context);
//                        }
//                        startService(context, command);
//                    }
...
//        intent.setAction(Constants.ServiceCommand.SERVICE_COMMAND);
//        intent.putExtra(Constants.MediaButtonCommand.CMD_NAME, command);
//        intent.putExtra(Constants.MediaButtonCommand.FROM_MEDIA_BUTTON, true);
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.MediaSourceManager) {
