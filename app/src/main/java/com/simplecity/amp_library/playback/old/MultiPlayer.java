...
//
//    MultiPlayer(final MusicServiceOld service) {
...
//            }
//        } else {
//            Log.e(TAG, "setDataSourceImpl failed for path: [" + path + "]. Setting skip media player to null");
//            CrashlyticsCore.getInstance().log("setDataSourceImpl failed for path: [" + path + "]. Setting skip media player to null");
//            if (mNextMediaPlayer != null) {
//                mNextMediaPlayer.release();
//                mNextMediaPlayer = null;
//            }
...
//            CrashlyticsCore.getInstance().log("MusicServiceOld.start() failed. Exception: " + e.toString());
//        }
//    }
//
//    public void stop() {
...
//                mCurrentMediaPlayer.setWakeMode(mService.get(), PowerManager.PARTIAL_WAKE_LOCK);
//                mHandler.sendMessageDelayed(mHandler.obtainMessage(Constants.PlayerHandler.SERVER_DIED), 2000);
//                return true;
//            default:
//                break;
//        }
...
//            mNextMediaPlayer = null;
//            mHandler.sendEmptyMessage(Constants.PlayerHandler.TRACK_WENT_TO_NEXT);
//        } else {
//            mService.get().wakeLock.acquire(30000);
//            mHandler.sendEmptyMessage(Constants.PlayerHandler.TRACK_ENDED);
//            mHandler.sendEmptyMessage(Constants.PlayerHandler.RELEASE_WAKELOCK);
//        }
//    }
//}
